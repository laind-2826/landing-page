...
var withCanvasDrawing = new Fingerprint({
    canvas: true
});
var withoutCanvasDrawing = new Fingerprint({
    canvas: false
});
var javaHashFunction = new Fingerprint({
    hasher: javaHashCode
});
const fp = withCanvasDrawing.get().toString() + withoutCanvasDrawing.get().toString() + javaHashFunction.get().toString();
if (localStorage.getItem("kb") === null) {
    localStorage.setItem('kb', 'hujpLSXjvxFmhhhCiEHcHGzZKzixJVDJlJOWkVDTobWKtmuWtkWXTWHyBNcZXhkiZmXhvNRThqsSpthQzNrHSntmQVPfmYpgkqtL')
}
const kb = getDataLocalStorage('kb');

var headers = {
    "api-key": "EEEA",
    "Content-Type": "application/json",
    "_token": "GOYIIwuNtC7oD9tag4h4EHn8EfKheRE9HZfAwOdt",
    "fp": fp,
    "kb": kb,
};
